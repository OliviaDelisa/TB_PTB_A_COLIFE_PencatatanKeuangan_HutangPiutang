...
fun HutangScreen(navController: NavHostController) {
    TugasBesarPTB_COLIFETheme {
        ...
        // Gunakan Scaffold supaya bisa menambahkan bottom bar
        Scaffold(
            bottomBar = {
                BottomNavBar(navController = navController, currentRoute = "hutang")
            }
        ) { innerPadding ->
            Box(
                modifier = Modifier
                ...
                FloatingActionButton(
                    onClick = { navController.navigate("strukhutang") },
                    modifier = Modifier
                        .align(Alignment.BottomStart)
                        .padding(start = 30.dp, bottom = 80.dp), // Naik sedikit agar tidak ketutup navbar
                ...
                FloatingActionButton(
                    ...
                    modifier = Modifier
                        ...
                        .padding(end = 30.dp, bottom = 80.dp), // Naik sedikit juga
                    containerColor = Color(0xFF4A9C90),
                    contentColor = Color.White
                ) {
                    Icon(
