...
fun BottomNavBar(navController: NavController, currentRoute: String?) {
    BottomAppBar(
        ...
        BottomNavItem(
            ...
            isSelected = currentRoute == "home" // Dinamis
        )
        BottomNavItem(
            label = "Pemasukan",
            icon = Icons.Default.AccountBalanceWallet,
            onClick = { /* TODO: Navigasi ke Home */ },
            isSelected = currentRoute == "daftarpemasukan" // Dinamis
        )
        BottomNavItem(
            label = "Pengeluaran",
            icon = Icons.Default.ShoppingCart,
            onClick = { navController.navigate("daftarpengeluaran") },
            isSelected = currentRoute == "daftarpengeluaran" || currentRoute == "tambahpengeluaran"
        )
        BottomNavItem(
            label = "Hutang",
            icon = Icons.Default.Receipt,
            onClick = { /* TODO: Navigasi ke Hutang */ },
            isSelected = currentRoute == "hutang" // Dinamis
        )
        BottomNavItem(
            label = "Profil",
            icon = Icons.Default.Person,
            onClick = { /* TODO: Navigasi ke Profil */ },
            isSelected = currentRoute == "profil" // Dinamis
        )
    }
}
